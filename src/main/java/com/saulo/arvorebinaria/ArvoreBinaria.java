package com.saulo.arvorebinaria;
...
public class ArvoreBinaria<T extends Comparable<T>> {
    ...
    public void remover(T conteudo) {
        try {
            ...
            if (atual == null) {
                System.out.println("Conteúdo '" + conteudo + "' não encontrado. Bloco try");
            }
            ...
            System.out.println("Conteúdo '" + conteudo + "' não encontrado. Bloco catch");
        }
    }
